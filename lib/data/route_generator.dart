    ...
    switch (settings.name) {
      ...
      case '/scoresWebPage':
        return MaterialPageRoute(
            builder: (_) => NewsStoryScreen(args as NewsStory));
      case '/gridView':
        return MaterialPageRoute(
            builder: (_) => GridViewScreen(args as String));
      case '/gridViewContent':
        return MaterialPageRoute(
            builder: (_) => GridViewContentScreen(args as String));
      case '/competition':
        return MaterialPageRoute(
            builder: (_) => CompetitionScreen(args as scoresCompetition));
      default:
        return _errorRoute();
    }
  }
