...
class TweetModel extends Tweet {
  ...
  TweetModel.fromJson(Map<String, dynamic> jsonTweet) {
    jsonTweet['retweeted_status'] != null
        ? TweetModel.retweetFromJson(jsonTweet)
        : jsonTweet['quoted_status'] != null
            ? TweetModel.quoteTweetFromJson(jsonTweet)
            : {
  ...
  TweetModel.retweetFromJson(Map<String, dynamic> jsonRetweet) {
    isRetweet = true;
    ...
    if (jsonRetweet['retweeted_status']['entities']['media'] != null) {
      ...
      spans[spans.length - 1] = _removeMediaURL(
          jsonRetweet['retweeted_status'], spans[spans.length - 1]);
    }
  }
  ...
  TweetModel.quoteTweetFromJson(Map<String, dynamic> jsonQuoteTweet) {
    isQuoteTweet = true;
    ...
    if (jsonQuoteTweet['quoted_status']['entities']['media'] != null) {
      ...
      spans[spans.length - 1] = _removeMediaURL(
          jsonQuoteTweet['quoted_status'], spans[spans.length - 1]);
    }
  }
  ...
  static TextSpan _removeUserMentions(
    ...
    String usermentions = "";
    String spanText = span.text as String;
    for (Map<String, dynamic> usermention in json['entities']
        ['user_mentions']) {
