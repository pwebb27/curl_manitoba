...
List<gridViewTile> COMPETITION_GRID_VIEW_TILES_DATA = [
  gridViewTile('Rules', FontAwesomePro.clipboard_list_check, 'assets/images/rules.PNG'),
  ...
  gridViewTile('Youth Events', FontAwesomePro.calendar_star,'assets/images/youth-events.PNG'),
  gridViewTile('Manitoba Sport Regions', FontAwesomePro.map_location_dot,'assets/images/manitoba-sport-regions.PNG'),
];
...
List<gridViewTile> HIGH_PERFORMANCE_GRID_VIEW_TILES_DATA = [
  ...
  gridViewTile('Find a Club', FontAwesomePro.magnifying_glass,'assets/images/find-a-club.PNG'),
  gridViewTile('What is Curling?', FontAwesomePro.circle_question,'assets/images/what-is-curling.PNG'),
  ...
  gridViewTile('COVID-19 Information', FontAwesomePro.virus_covid,'assets/images/covid-19.PNG'),
  ...
  gridViewTile('Volunteer Opportunities', FontAwesomePro.hand_heart,'assets/images/volunteers.PNG'),
  gridViewTile('Scholarships', FontAwesomePro.diploma,'assets/images/scholarships.PNG'),
  gridViewTile('Awards', FontAwesomePro.award,'assets/images/awards.PNG',31),
  gridViewTile('History', FontAwesomePro.scroll,'assets/images/history.PNG'),
